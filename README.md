# SSO Bulk Load
This project is designed to facilitate bulk user creation in Red Hat Single Sign-On (RH-SSO), enabling extensive performance testing of the system.

## Important
This project is not affiliated with Red Hat and is not an official endeavor. It's a personal initiative designed to assist me in testing RH-SSO. Use this project at your own risk. It is not recommended for use in a production environment.
...
* CONFIG.KEYCLOAK.REALM is the realm of the RH-SSO.
